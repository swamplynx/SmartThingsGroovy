...
metadata {
	definition (name: "Whistle Presence", namespace: "swamplynx", author: "SwampLynx", mnmn:"SmartThings", cstHandler:true, vid:"generic-arrival", ocfDeviceType:"x.com.st.d.mobile.presence") {
