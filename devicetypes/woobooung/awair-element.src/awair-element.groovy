...
metadata {
    definition(name: "Awair-Element", namespace: "WooBooung", author: "Booung", vid: "SmartThings-smartthings-Awair", ocfDeviceType: "x.com.st.d.airqualitysensor") {
...
*/
    ...
    tiles {
        multiAttributeTile(name: "airQuality", type: "generic", width: 6, height: 4, canChangeIcon: true) {
